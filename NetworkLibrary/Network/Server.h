...
public:
	...
	// 인자 미정
	virtual void onAccept(__int64 sessionId);

	virtual void onRelease(__int64 sessionId);

	virtual void onRecv(__int64 sessionId, Packet& packet);

	virtual void onError(int errorCode, wchar_t* str);
