    ...
    switch (packet->GetHeaderPtr()->type_)
    {
        ...
        case 51:
        {
            ...
            *packet >> icon >> curMoney;
            ...
            return ResBuyIcon(icon, curMoney);
        }
        case 52:
        {
			int inventoryId;
        ...
        case 67:
        {
            ...
            *packet >> winner >> myRating >> opponentRating >> myMoney;
            ...
            return ResGameResult(winner, myRating, opponentRating, myMoney);
        }
        case 68:
        {
			int playerId;
            ...
            *packet >> playerId >> rating;
            ...
            return ResChangePlayerRating(playerId, rating);
        }
        case 69:
        {
			int playerId;
...
bool RpcClientStub::ResPlayerIcons(std::vector<Icon>& icons)
{
    return true;
}
...
bool RpcClientStub::ReqBuyIcon()
{
    return true;
}

bool RpcClientStub::ResBuyIcon(Icon& icon, int curMoney)
{
    return true;
}
...
bool RpcClientStub::ResGameResult(STONE winner, int myRating, int opponentRating, int myMoney)
{
    return true;
}

bool RpcClientStub::ResChangePlayerRating(int playerId, int rating)
{
    return true;
}
