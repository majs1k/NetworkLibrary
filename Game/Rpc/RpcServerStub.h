...
public:
    ...
    virtual bool ResPlayerIcons(__int64 sessionId, std::vector<Icon>& icons);
    ...
    virtual bool ReqBuyIcon(__int64 sessionId);
    virtual bool ResBuyIcon(__int64 sessionId, Icon& icon, int curMoney);
    ...
    virtual bool ResGameResult(__int64 sessionId, STONE winner, int myRating, int opponentRating, int myMoney);
    virtual bool ResChangePlayerRating(__int64 sessionId, int playerId, int rating);
